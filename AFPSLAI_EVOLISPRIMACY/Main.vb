Public Class Main
    ...
    Private Sub BindData(ByVal rw As DataRow)
        ...
        CompleteAddress = String.Format("{0}{1}{2}{3}{4}{5}{6}", _
                                        Address1, _
                                        IIf(Address2 = "", "", " " & Address2), _
                                        IIf(Address3 = "", "", " " & Address3), _
                                        IIf(AddressCity = "", "", " " & AddressCity), _
                                        IIf(AddressProvince = "", "", " " & AddressProvince), _
                                        IIf(AddressCountry = "", "", " " & AddressCountry), _
    ...
    Private Sub PrintCard()
        If txtIDNumber_Write.Text.Split("_").Count <> 3 Then
        ...
        If GenerateBarcode(txtCIF_Write.Text) Then
            Dim pc As New PrintCard(txtCIF_Write.Text, CompleteName, txtAddress.Text, txtContactNos.Text, txtDOB_Write.Text, txtIDNumber_Write.Text, txtDateIssued_Write.Text, txtContactName.Text, txtContactContactNos.Text, txtBranchIssued_Write.Text, PhotoPath, SignaturePath, BarcodeJPG, chkIncludeIdTemplate.Checked.ToString)
            pc.X = txtX.Text
            pc.Y = txtY.Text
    ...
    Private Sub btnProcessCard_Click(sender As System.Object, e As System.EventArgs) Handles btnProcessCard.Click
        ...
        If chkMagEncode.Checked Then
            If chkChipEncode.Checked Then ChipEncode()
        Else
            FeedCard()
            If chkChipEncode.Checked Then ChipEncode()
        End If
    ...
    Private Sub pic1_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles pic1.Paint
        If ShowPreview Then
            Dim imgPhoto As Image = Image.FromStream(New System.IO.MemoryStream(System.IO.File.ReadAllBytes(PhotoPath)))
