...
#Region " Printing "
    ...
    Public Sub New(ByVal ParamArray param() As String)
        cardElements = param
    End Sub
    ...
    Private Sub m_pDoc_PrintPage(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles m_pDoc.PrintPage
        Try
            ...
            If intPage = 1 Then
                ...
                Dim imgSignature As Image = Image.FromStream(New System.IO.MemoryStream(System.IO.File.ReadAllBytes(cardElements(11))))
            ...
            ElseIf intPage = 2 Then
                ...
                Dim myBitmap2 As New Bitmap("Images\pres_sign.png")
